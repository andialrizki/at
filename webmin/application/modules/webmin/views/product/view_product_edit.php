      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body border-radius-none">
            <form class="form-horizontal" id="form" action="<?php echo webmin_url('product/edit/'.$data->product_id.'?action=save') ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label class="control-label col-sm-3">Product Name</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="post[product_name]" value="<?php echo $data->product_name ?>" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div style="max-width: 400px; max-height: 400px; overflow: auto;">
                    <?php foreach ($cat as $d): ?>
                      <?php $check = $this->db->where('prodcat_product_id', $data->product_id)->where('prodcat_category_id', $d->category_id)->get('product_category')->num_rows(); ?>
                      <input type="checkbox" name="prodcat[]" value="<?php echo $d->category_id ?>" <?php echo ($check > 0 ? 'checked':'') ?>> <?php echo $d->category_name ?><br>
                    <?php endforeach ?>
                  </div>
                </div>
              </div>
                ...
                <div class="col-sm-9">
                  <div style="max-width: 400px; max-height: 400px; overflow: auto;">
                    <?php foreach ($brand as $d): ?>
                      <?php $check = $this->db->where('prodbrand_product_id', $data->product_id)->where('prodbrand_brand_id', $d->brand_id)->get('product_brand')->num_rows(); ?>
                      <input type="checkbox" name="prodbrand[]" value="<?php echo $d->brand_id ?>" <?php echo ($check > 0 ? 'checked':'') ?>> <?php echo $d->brand_name ?><br>
                    <?php endforeach ?>
                  </div>
                </div>
              </div>
                  ...
                  <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active" id="tab_1">
                        <textarea id="ckeditor" name="post[product_description_en]"><?php echo $data->product_description_en ?></textarea>
                      </div>
                      <div class="tab-pane" id="tab_2">
                        <textarea id="ckeditor2" name="post[product_description_id]"><?php echo $data->product_description_id ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <div id="image"><img src="<?php echo prodimg_url($data->product_image) ?>" style="max-width:200px;" class="img-responsive"></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <a href="<?php echo prodimg_url($data->product_brochure) ?>" target="_blank"><?php echo $data->product_brochure ?></a>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" name="post[product_sort]" value="<?php echo ($data->product_sort) ?>" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="form-control" name="post[product_status]" required>
                    <option value="<?php echo $data->product_status ?>"><?php echo checkStatus($data->product_status) ?></option>
