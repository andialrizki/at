              ...
              <tbody>
                ...
                <?php foreach ($data->result() as $d): ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-success btn-xs" onclick="formedit('<?php echo $d->banner_id ?>', '<?php echo $d->banner_name ?>', '<?php echo $d->banner_sort ?>', '<?php echo $d->banner_image ?>', '<?php echo $d->banner_status ?>', '<?php echo $d->banner_url ?>');">Edit</a> 
                      <a href="<?php echo webmin_url('banner/remove/'.$d->banner_id) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete : <?php echo $d->banner_name ?>? ');">Remove</a>
                    </td>
                  </tr>
                  <?php $no++ ?>
                <?php endforeach ?>
...
<div class="modal fade" id="modal-add">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" id="form" action="<?php echo webmin_url('banner?action=save') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control" id="f2" name="post[banner_sort]" value="<?php echo ($data->num_rows()+1) ?>" required>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3">Url</label>
            <div class="col-sm-3">
              <input type="text" class="form-control" id="f5" name="post[banner_url]">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control" name="post[banner_status]" id="f4" required>
