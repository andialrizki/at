...
<html>
  ...
  <body class="hold-transition login-page" style="background: url('<?php echo private_url('dist/img/background.jpg') ?>') no-repeat; background-size: 100%">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo webmin_url('auth/process') ?>" method="post">
