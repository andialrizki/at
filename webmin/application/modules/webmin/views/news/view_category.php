                ...
                <?php foreach ($data->result() as $d): ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="<?php echo webmin_url('news/remove/category/'.$d->category_id) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete : <?php echo $d->category_name ?>? ');">Remove</a>
                    </td>
                  </tr>
                  <?php $no++ ?>
                <?php endforeach ?>
...
<div class="modal fade" id="modal-add">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" id="form" action="<?php echo webmin_url('news/category?action=save') ?>" method="post">
